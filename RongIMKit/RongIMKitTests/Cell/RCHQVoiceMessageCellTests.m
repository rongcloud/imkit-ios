...
@interface RCHQVoiceMessageCellTests : XCTestCase

@end

@implementation RCHQVoiceMessageCellTests
...
-(void)testInit{
    RCHQVoiceMessageCell *item = [[RCHQVoiceMessageCell alloc]initWithFrame:CGRectMake(0, 0, 0, 0)];
