...
@interface RCCSLeaveMessagesCellTests : XCTestCase

@end

@implementation RCCSLeaveMessagesCellTests
...
-(void)testInit{
    RCCSLeaveMessagesCell *item = [[RCCSLeaveMessagesCell alloc]initWithFrame:CGRectMake(0, 0, 0, 0)];
