...
@interface RCLocationMessageCellTests : XCTestCase

@end

@implementation RCLocationMessageCellTests

- (void)setUp {
    // Put setup code here. This method is called before the invocation of each test method in the class.
}
-(void)testInit{
    RCLocationMessageCell *item = [[RCLocationMessageCell alloc]initWithFrame:CGRectMake(0, 0, 0, 0)];
